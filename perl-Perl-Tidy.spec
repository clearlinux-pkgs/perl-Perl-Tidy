...
%prep
%setup -q -n Perl-Tidy-20200110
cd %{_builddir}/Perl-Tidy-20200110
...
cp %{_builddir}/Perl-Tidy-20200110/COPYING %{buildroot}/usr/share/package-licenses/perl-Perl-Tidy/4cc77b90af91e615a64ae04893fdffa7939db84c
if test -f Makefile.PL; then
