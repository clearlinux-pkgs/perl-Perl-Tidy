...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHANCOCK/Perl-Tidy-20240202.tar.gz
...
%prep
%setup -q -n Perl-Tidy-20240202
cd %{_builddir}/Perl-Tidy-20240202
pushd ..
cp -a Perl-Tidy-20240202 buildavx2
popd
