...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHANCOCK/Perl-Tidy-20240903.tar.gz
...
%prep
%setup -q -n Perl-Tidy-20240903
cd %{_builddir}/Perl-Tidy-20240903
pushd ..
cp -a Perl-Tidy-20240903 buildavx2
popd
