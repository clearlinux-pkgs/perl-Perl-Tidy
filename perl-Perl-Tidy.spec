...
%prep
%setup -q -n Perl-Tidy-20220217
cd %{_builddir}/Perl-Tidy-20220217
...
cp %{_builddir}/Perl-Tidy-20220217/COPYING %{buildroot}/usr/share/package-licenses/perl-Perl-Tidy/4cc77b90af91e615a64ae04893fdffa7939db84c
if test -f Makefile.PL; then
