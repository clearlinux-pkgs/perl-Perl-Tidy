...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHANCOCK/Perl-Tidy-20200619.tar.gz
...
%prep
%setup -q -n Perl-Tidy-20200619
cd %{_builddir}/Perl-Tidy-20200619
...
cp %{_builddir}/Perl-Tidy-20200619/COPYING %{buildroot}/usr/share/package-licenses/perl-Perl-Tidy/4cc77b90af91e615a64ae04893fdffa7939db84c
if test -f Makefile.PL; then
