...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHANCOCK/Perl-Tidy-20230912.tar.gz
...
%prep
%setup -q -n Perl-Tidy-20230912
cd %{_builddir}/Perl-Tidy-20230912
pushd ..
cp -a Perl-Tidy-20230912 buildavx2
popd
