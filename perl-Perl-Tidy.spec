...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHANCOCK/Perl-Tidy-20250105.tar.gz
...
%prep
%setup -q -n Perl-Tidy-20250105
cd %{_builddir}/Perl-Tidy-20250105
pushd ..
cp -a Perl-Tidy-20250105 buildavx2
popd
